	...
	if (!empty($pmpro_invoice)) {
		...
		?>
			<ul>
				...
				<li><strong><?php esc_html_e('Membership Level', 'paid-memberships-pro'); ?>:</strong> <?php if (!empty($pmpro_invoice->membership_level)) echo esc_html($pmpro_invoice->membership_level->name);
			...
			<div>
				<a class="tutor-btn tutor-btn-primary " href="<?php echo esc_url(home_url('/student-dashboard')); ?>">Dashboard</a>
				<a class="tutor-btn tutor-btn-primary " href="<?php echo esc_url(home_url('/members/me')); ?>">Profile</a>
			</div>
